defmodule ExplorerWeb.TokenController do
  ...
  def show(conn, %{"id" => address_hash_string} = params) do
    with {:ok, address_hash} <- Chain.string_to_address_hash(address_hash_string),
         ...
         token_transfers <- TokenTransfer.fetch_token_transfers_from_token_hash(address_hash, paging_options(params)) do
      ...
      render(
        ...
        token: token,
        total_token_transfers: TokenTransfer.count_token_transfers_from_token_hash(address_hash),
        total_address_in_token_transfers:
          TokenTransfer.count_addresses_in_token_transfers_from_token_hash(address_hash),
